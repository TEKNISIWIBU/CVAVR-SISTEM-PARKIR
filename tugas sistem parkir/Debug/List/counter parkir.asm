...
_0x0:
	.DB  0x70,0x61,0x72,0x6B,0x69,0x72,0x20,0x63
	.DB  0x6F,0x75,0x6E,0x74,0x65,0x72,0x0,0x70
	.DB  0x6F,0x6C,0x69,0x6E,0x65,0x6D,0x61,0x0
	.DB  0x6A,0x75,0x6D,0x6C,0x61,0x68,0x3A,0x20
	.DB  0x0,0x70,0x61,0x72,0x6B,0x69,0x72,0x20
	.DB  0x70,0x65,0x6E,0x75,0x68,0x0,0x20,0x20
...
;#define tombol_IN PINA.3
;#define tombol_OUT PINA.4
;
;int parkir = 0;
;char buff[10];
;int kapasitas = 20;
...
; 0000 0091 // RS - PORTC Bit 7
; 0000 0092 // RD - PORTC Bit 6
; 0000 0093 // EN - PORTC Bit 5
; 0000 0094 // D4 - PORTC Bit 0
; 0000 0095 // D5 - PORTC Bit 1
; 0000 0096 // D6 - PORTC Bit 2
; 0000 0097 // D7 - PORTC Bit 3
; 0000 0098 // Characters/line: 8
; 0000 0099 lcd_init(16);
	LDI  R26,LOW(16)
	RCALL _lcd_init
; 0000 009A       lcd_gotoxy(0,0);
	CALL SUBOPT_0x0
; 0000 009B       lcd_putsf("parkir counter");
	__POINTW2FN _0x0,0
	RCALL _lcd_putsf
; 0000 009C       lcd_gotoxy(3,1);
	LDI  R30,LOW(3)
	CALL SUBOPT_0x1
; 0000 009D       lcd_putsf("polinema");
	__POINTW2FN _0x0,15
	RCALL _lcd_putsf
...
; 0000 00A3       lcd_gotoxy(0,0);
	CALL SUBOPT_0x0
; 0000 00A4       lcd_putsf("jumlah: ");
	CALL SUBOPT_0x2
; 0000 00A5       //penjumlah atau masuknya kendaraan ke dalam parkiran
; 0000 00A6       if(tombol_IN == 0){
	SBIC 0x19,3
	RJMP _0x6
; 0000 00A7       parkir++;
	MOVW R30,R4
...
_0x9:
; 0000 00AD 
; 0000 00AE       //pengurang atau keluarnya kendaran dari parkiran
; 0000 00AF       if(tombol_OUT == 0){
	SBIC 0x19,4
	RJMP _0xA
; 0000 00B0       parkir--;
	MOVW R30,R4
...
; 0000 00BA       };
_0xE:
; 0000 00BB       if(parkir >= kapasitas){
	__CPWRR 4,5,6,7
	BRLT _0xF
; 0000 00BC         parkir = kapasitas;
	MOVW R4,R6
; 0000 00BD         lcd_gotoxy(0,1);
	LDI  R30,LOW(0)
	CALL SUBOPT_0x1
; 0000 00BE         lcd_putsf("parkir penuh");
	__POINTW2FN _0x0,33
	RCALL _lcd_putsf
; 0000 00BF         PORTB = 0x00;
	LDI  R30,LOW(0)
	OUT  0x18,R30
; 0000 00C0         tombol_IN = 1;
	SBI  0x19,3
; 0000 00C1       };
_0xF:
; 0000 00C2        if(parkir <= kapasitas){
	__CPWRR 6,7,4,5
	BRLT _0x12
; 0000 00C3         lcd_gotoxy(0,0);
	CALL SUBOPT_0x0
; 0000 00C4         lcd_putsf("jumlah: ");
	CALL SUBOPT_0x2
